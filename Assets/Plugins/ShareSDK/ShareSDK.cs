	...
	public class ShareSDK : MonoBehaviour 
	{
...
#if UNITY_ANDROID
		public string appKey = "23cb4646d73ae";
		public string appSecret = "20f28f48d70dc313cb2edf1bdc42d54f";
#elif UNITY_IPHONE
		public string appKey = "23cb4646d73ae";
		public string appSecret = "20f28f48d70dc313cb2edf1bdc42d54f";
#endif
		...
		void Awake()
		{
			...
			foreach (FieldInfo devInfoField in devInfoFields) 
			{
                ...
                if (info != null)
                {
                    fi = info.GetType().GetField("type");
                    if (fi != null)
                        platformId = (int)fi.GetValue(info);
                }
